<section class="about-us" id="aboutus">
	<div class="container">
		...
		<!-- Nick Test -->
		<iframe width="1200" height="600" src="https://www.youtube.com/embed/zQ9ijVZ-r_4" frameborder="0" allowfullscreen></iframe> &nbsp<h3>Sunantha Camila Foundation</h3> &nbsp <hr />
		<!-- End Nick Test -->
	...
	<?php
		if(is_active_sidebar( 'sidebar-aboutus' )):
			echo '<div class="our-clients">';
				echo '<h2><span class="section-footer-title">'.__('&#9753').'</span></h2>';
			echo '</div>';
